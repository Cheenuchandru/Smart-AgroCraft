...
<li class="ash1"><i class="fas fa-map-marker-alt order order4"></i><br><i class="fa fa-times aria" aria-hidden="true"></i><<br>Reached</li>
    ...
    <table class=tab>
        ...
        <tr align="center" class=trow>
            <th align="center">chan</th>
            <th align="center">6374344282</th>
            <th align="center">ABCD</th>
            <th align="center">chan-Apples</th>
    ...
    <div class="morefooter">
        ...
        <div class="call">
            ...
            <a href="#" style="color:black;">+91-6374344282</a>
        </div>
    ...
    <div class="instaid">
        ...
        <div class="gmailid">
            <a href="#" class="hypher" style="color:black;">agrocraft</a>
        </div>

    </div>
    <div class="copy">
        <h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy;</h5>
    </div>
